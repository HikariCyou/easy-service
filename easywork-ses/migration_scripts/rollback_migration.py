...
class MigrationRollback:
    ...
    async def reset_evaluation_references(self) -> int:
        ...
        try:
            ...
            evaluations_with_personnel_id = await PersonEvaluation.filter(personnel_id__isnull=False).count()

            await PersonEvaluation.filter(personnel_id__isnull=False).update(personnel_id=None)
